(function () {
  ...
  function prepareSiteSearchPages() {
    var sourcePages = getSiteSearchIndexPages();
  ...
  function initSiteSearch() {
    ...
    var scoreCurrentPageSection = function (section, query) {
  ...
  function initHomeVerticalView() {
    ...
    Array.prototype.forEach.call(containers, function (container, containerIndex) {
      ...
      function refreshLeafGridOverlay(childrenWrap) {
        ...
        var overlay = ensureLeafGridOverlay(childrenWrap);
      ...
      function buildNode(node) {
        ...
        if (childNodes.length && !lockedOpen) {
          ...
          toggle.setAttribute(
            "aria-label",
            (expanded ? getUiString("collapse-section", "Collapse section") : getUiString("expand-section", "Expand section"))
              + ": "
  ...
  function initHomeFilter() {
    ...
    var renderHomeSearchResult = function (record, query) {
      ...
      return ""
        + '<a class="site-search-result home-filter-result" href="' + escapeHtml(record.url || "#") + '">'
    ...
    var applyFilter = function () {
      ...
      var records = collectHomeSearchRecords(cards);
      var ranked = query
